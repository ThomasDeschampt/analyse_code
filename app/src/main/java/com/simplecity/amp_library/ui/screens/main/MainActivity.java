...
public class MainActivity extends BaseActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        analyticsManagertest.dropBreadcrumb(TAG, "onCreate()");
        ...
        if (Aesthetic.isFirstTime(this)) {
            ...
            analyticsManagertest.logInitialTheme(theme);
        }
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        analyticsManagertest.dropBreadcrumb(TAG, "onServiceConnected()");
    ...
    protected void onPause() {
        ...
        analyticsManagertest.dropBreadcrumb(TAG, "onPause()");
    }
    ...
    protected void onDestroy() {
        ...
        analyticsManagertest.dropBreadcrumb(TAG, "onDestroy()");
    }
    ...
    private void showChangelogDialog() {
        int storedVersionCode = settingsManagertest.getStoredVersionCode();
        ...
        if (storedVersionCode != -1 && storedVersionCode < BuildConfig.VERSION_CODE) {
            if (settingsManagertest.getShowChangelogOnLaunch()) {
                ChangelogDialog.Companion.newInstance().show(getSupportFragmentManager());
            }
        }
        settingsManagertest.setVersionCode();
    }
